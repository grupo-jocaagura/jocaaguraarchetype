...
void main() {
  group('ResponsiveSizeWidget', () {
    testWidgets(
        'elige builder según deviceType y usa fallback cuando corresponde',
        (WidgetTester tester) async {
      // Creamos un Fake y tomamos sus thresholds
      final _FakeBlocResponsive fake =
          _FakeBlocResponsive(initial: const Size(360, 800));
  ...
  group('ResponsiveGeneratorWidget', () {
    testWidgets(
        'genera itemCount widgets con ancho por span y padding/gap por defecto',
        (WidgetTester tester) async {
      final _FakeBlocResponsive fake =
  ...
  group('ResponsiveNxBase derivados (1x1 / 1x2 / 1x3)', () {
    testWidgets(
        'ancho se corresponde con widthByColumns(n) y mantiene relación 1 < 2 < 3',
        (WidgetTester tester) async {
      final _FakeBlocResponsive fake =
      ...
      final double w1 =
          tester.getSize(find.byKey(const ValueKey<String>('x1'))).width;
      final double w2 =
          tester.getSize(find.byKey(const ValueKey<String>('x2'))).width;
      final double w3 =
          tester.getSize(find.byKey(const ValueKey<String>('x3'))).width;
